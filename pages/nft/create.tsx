...
const NftCreate: NextPage = () => {
    ...
    const [nftMeta, setNftMeta] = useState<NftMeta>({
        name: "Aadhaar-NFT",
        description: "This is a Aadhaar-NFT once issued to a address it cannot be transferred and is used as a identification card in the web3 space",
        image: "",
        attributes: [
            {detail_type: "Name", value: ""},
            {detail_type: "Address", value: ""},
            {detail_type: "Web3_Address", value: ""},
            {detail_type: "Aadhaar_No", value: ""},
            {detail_type: "DOB", value: ""},
            {detail_type: "SEX", value: ""}
        ]
    });
    ...
    const handleAttributeChange = (e: ChangeEvent<HTMLInputElement>) => {
        const { name, value } = e.target;
        const attributeIdx = nftMeta.attributes.findIndex(attr => attr.detail_type === name);
    ...
    const createNft = async () => {
        try {
           ...
           const attribute=nftMeta.attributes;
            const tx = await contract?.safeMint(
                attribute[2].value,nftURI,attribute[0].value,attribute[4].value,attribute[5].value,attribute[1].value,attribute[3].value
            );
                      ...
                      />
                                        ...
                                        <div className="grid grid-cols-6 gap-6">
                                            { nftMeta.attributes.map(attribute =>
                                                <div key={attribute.detail_type} className="col-span-6 sm:col-span-6 lg:col-span-2">
                                                    <label htmlFor={attribute.detail_type} className="block text-sm font-medium text-gray-700">
                                                    ...
                                                    <input
                                                        ...
                                                        type="text"
                                                        name={attribute.detail_type}
                                                        id={attribute.detail_type}
