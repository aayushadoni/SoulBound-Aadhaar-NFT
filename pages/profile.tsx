...
import { useCreatedNfts } from '@hooks/web3';
          ...
          <div className="flex-1 flex items-stretch overflow-hidden">
            <main className="flex-1 overflow-y-auto">
              <div className="pt-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex">
                  <h1 className="flex-1 text-2xl font-bold text-gray-900">Your Created Aadhaar NFTs</h1>
                </div>
                ...
                <div>
                  ...
                  <dl className="mt-2 border-t border-b border-gray-200 divide-y divide-gray-200">
                    {activeNft.meta.attributes.map((attr) => (
                      <div key={attr.detail_type} className="whitespace-pre-wrap py-3 flex justify-between text-sm font-medium">
                        <dt className="text-gray-500">{attr.detail_type}: </dt>
                        <dd className="break-all text-gray-900 text-right">{attr.value}</dd>
                      </div>
                    ))}
                  </dl>
                </div>
