import { createContext, FunctionComponent, useContext, useEffect, useState, ReactNode } from "react"
import { createDefaultState, createWeb3State, loadContract, Web3State } from "./utils";
import { ethers } from "ethers";
import { MetaMaskInpageProvider } from "@metamask/providers";
import {Aadhaar} from "@_types/Aadhaar";
  ...
  useEffect(() => {
    async function initWeb3() {
      try {
        ...
        const contract =  await loadContract("Aadhaar", provider);
        ...
        setWeb3Api(createWeb3State({
          ...
          provider,
          contract: signedContract as unknown as Aadhaar,
          isLoading: false
        }))
      } catch(e: any) {
